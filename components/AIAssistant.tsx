                ...
                {showContact ? (
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-2">
                      <a href="mailto:hello@example.com" className="bg-primary text-white rounded-lg px-4 py-2 font-medium hover:bg-primary/90 transition-all">Dein Projekt jetzt besprechen</a>
                    </div>
                  </motion.div>
                ) : response && (
                  <motion.div
